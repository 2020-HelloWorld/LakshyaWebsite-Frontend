      ...
      <div className="max-w-md w-full bg-white rounded-lg border-solid p-8 relative border-darkgray border-[1px] mt-40">
        ...
        <div className="border border-gray-300  rounded-lg p-4 mb-4">
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              <label htmlFor="firstName" className="block text-sm font-bold font-oxygen text-gray-700">First Name</label>
              <input type="text" id="firstName" placeholder="John" className="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-black border-[1px] rounded-md h-7" />
            </div>
            <div>
              <label htmlFor="lastName" className="block text-sm font-bold font-oxygen text-gray-700">Last Name</label>
              <input type="text" id="lastName" placeholder="Doe" className="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-black border-[1px] rounded-md h-7" />
            </div>
          </div>
          <div className='mt-5'>
          ...
          <div className='mt-5'>
            <p className="block text-sm font-bold font-oxygen text-gray-700">Resume</p>
            <label htmlFor="resume" className="flex items-center text-sm font-bold font-oxygen text-blue-500 cursor-pointer bg-blue-100 p-2 rounded-md w-1/2">
            <img src={download} alt="Download icon" className="w-4 h-4 mr-2 " />
            {selectedResumeFile ? selectedResumeFile : 'Upload Resume'}
        ...
        <div className="mt-6">
          ...
          <input type="text" id="currentCity" placeholder="New York" className="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-black border-[1px] rounded-md h-7" />
        </div>
        <div className="mt-6">
