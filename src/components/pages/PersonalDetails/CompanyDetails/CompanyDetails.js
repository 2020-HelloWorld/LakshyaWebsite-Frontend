      ...
      <div className="max-w-md w-full bg-white rounded-lg border-solid p-8 relative border-darkgray border-[1px] mt-40">
        ...
        <div className="border border-gray-300  rounded-lg p-4 mb-4">
          <div className="mb-4">
              ...
              <label htmlFor="fullName" className="block text-sm font-bold font-oxygen text-gray-700">Company Name</label>
              <input type="text" id="fullName" placeholder="e.g.Microsoft" className="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-black border-[1px] rounded-md h-7" />
            
          </div>
          <div className='mt-5'>
            <p className="block text-sm font-bold font-oxygen text-gray-700">Company Logo</p>
            ...
            <img src={download} alt="Download icon" className="w-4 h-4 inline-block mr-2 " />
            {selectedProfileFile ? selectedProfileFile : 'Upload Company Logo'}
        ...
        <div>
          <div>
            <label htmlFor="email" className="block text-sm font-bold font-oxygen text-gray-700">Company Email</label>
        ...
        <div className="mt-6">
          <label htmlFor="location" className="block text-sm font-bold font-oxygen text-gray-700">Location</label>
          <input type="text" id="location" placeholder="New York" className="mt-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-black border-[1px] rounded-md h-7" />
        </div>
       
      <div className="mt-6">
        <label className="block text-sm font-bold font-oxygen text-gray-700">Languages</label>
