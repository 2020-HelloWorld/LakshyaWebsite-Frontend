...
{/*Page to display the companies that have partnered with Lakshya */}
    ...
    <section>
      <div className="p-8 md:p-16 lg:p-24 flex flex-col items-center">
        ...
        <div className="flex justify-center">
          <img src={stanford} alt="stanford" className="w-24 h-24 md:w-36  lg:w-48 m-4" />
          <img src={microsoft} alt="microsoft" className="w-24 h-24 md:w-36  lg:w-48 m-4" />
          <img src={intel} alt="infosis" className="w-24 h-24 md:w-36 lg:w-48 m-4" />
          <img src={infosis} alt="intel" className="w-24 h-24 md:w-36 lg:w-48 m-4" />
        </div>
      </div>
    </section>
  );
